...
public class MainActivity extends AppCompatActivity
    ...
    private void createTestData(){
        mRealm.executeTransaction(new Realm.Transaction(){
            ...
            public void execute(Realm realm){
                ...
                diary.title = "テキストタイトル";
                diary.bodyText = "テキスト本文です。";
                diary.date = "Feb 22";
            }
        });
    }
    ...
    private void showDiaryList(){
        ...
        Fragment fragment = manager.findFragmentByTag("diaryLitFragment");
        if(fragment == null){
            fragment = new DiaryListFragment();
            FragmentTransaction transaction = manager.beginTransaction();
            transaction.add(R.id.content,fragment,"DiaryListFrangment");
            transaction.commit();
        }
    }
